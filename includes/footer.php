                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="m-0 text-white">Vishwa Tech</h1><br>
                        </a>Vishwa is an IT website that is committed to providing innovative solutions to businesses in a variety of industries. Our team of experienced professionals specializes in software development, web design and development, mobile application development, and digital marketing.  </p>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">contact@vishwatech.com</p>
                            </div>
                            <div class="d-flex mb-2">
 ...
 +91 7410128888
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>SEO</a>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white " href="#"> Copyright 2023  </a> | Developed by Team (<a  href="https://yashyadav.ml"> Yash Yadav  & Shreyash Zalte) </a> </b></a></p>
                    </div>
                </div>
            </div>
        </div>
